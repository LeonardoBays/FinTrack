...
void main() {
  ...
  test(
    'DeleteTransaction UseCase deve chamar repository.deleteTransaction com o ID correto',
    () async {
      // Arrange
      const tId = '123';
      when(
  ...
  test(
    'DeleteTransaction UseCase deve propagar exceção se o repositório falhar',
    () async {
      // Arrange
      const tId = '123';
      when(
        () => mockRepository.deleteTransaction(any()),
      ).thenThrow(Exception('Erro no BD'));
